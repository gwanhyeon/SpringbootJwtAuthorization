...
public class AuthorizationTest {
    ...
    public void JWT_토큰_생성() throws Exception {
        ...
        user.setName("moodof ddd");
        user.setImageUrl("https://lh6.googleusercontent.com/-4vjsYgdYzVE/AAAAAAAAAAI/AAAAAAAAAAA/AMZuuckpFmWzV5cRiDCebObd-AidXzUC8g/s96-c/photo.jpg");
